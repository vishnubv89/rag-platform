...
def _route_after_router(state: AgentState) -> str:
    """After routing, go to retriever or skip straight to generator."""
    return state.get("_route", "retrieve")


def _route_after_grader(state: AgentState) -> str:
    """After grading: pass → generate, fail-with-budget → rewrite, fail-exhausted → generate."""
